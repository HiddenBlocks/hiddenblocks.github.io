    ...
    defaultsDeep({}, base, {
        ...
        plugins: base.plugins.concat([
            ...
            new HtmlWebpackPlugin({
                ...
                template: 'src/playground/index.ejs',
                filename: 'index.html',
                title: 'HiddenBlocks - A mod of PenguinMod',
                ...htmlWebpackPluginCommon
            }),
            new HtmlWebpackPlugin({
                chunks: ['fullscreen'],
            ...
            new HtmlWebpackPlugin({
                ...
                template: 'src/playground/index.ejs',
                filename: 'embed.html',
                title: 'Embedded Project - HiddenBlocks',
                noTheme: true,
                ...htmlWebpackPluginCommon
            }),
            new HtmlWebpackPlugin({
                ...
                title: 'Addon Settings - HiddenBlocks',
                ...htmlWebpackPluginCommon
            }),
            new HtmlWebpackPlugin({
                chunks: ['credits'],
                ...
                title: 'HiddenBlocks, PenguinMod & TurboWarp Credits',
                noSplash: true,
                ...htmlWebpackPluginCommon
            }),
